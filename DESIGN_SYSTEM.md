...
4. STACK             Compact operating table + focused badge set
...
- The stack table is an operating map, not a resume keyword dump.
- Current lanes: `SYSTEMS`, `WEB`, `MOBILE`, `AI_WORKFLOWS`, `CLOUD_DATA`.
- Keep the table indexed and compact. Do not use Mermaid here unless the profile strategy changes.
